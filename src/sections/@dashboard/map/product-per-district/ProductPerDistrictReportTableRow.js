...
import { Avatar, Checkbox, MenuItem, Stack, TableCell, TableRow, Typography } from '@mui/material';
...
ProductPerDistrictReportTableRow.propTypes = {
...
export default function ProductPerDistrictReportTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
