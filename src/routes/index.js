...
const GeneralEcommerce = Loadable(lazy(() => import('../pages/dashboard/general/GeneralEcommerce')));
const GeneralAnalytics = Loadable(lazy(() => import('../pages/dashboard/general/GeneralAnalytics')));
const GeneralBanking = Loadable(lazy(() => import('../pages/dashboard/general/GeneralBanking')));
const GeneralBooking = Loadable(lazy(() => import('../pages/dashboard/general/GeneralBooking')));

// ECOMMERCE
const EcommerceShop = Loadable(lazy(() => import('../pages/dashboard/ecommerce/EcommerceShop')));
const EcommerceProductDetails = Loadable(lazy(() => import('../pages/dashboard/ecommerce/EcommerceProductDetails')));
...
const EcommerceCheckout = Loadable(lazy(() => import('../pages/dashboard/ecommerce/EcommerceCheckout')));
...
const ProductSalesReport = Loadable(lazy(() => import('../pages/dashboard/product/ProductSalesReport')));
